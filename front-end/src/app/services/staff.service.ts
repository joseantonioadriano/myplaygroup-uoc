...
@Component({
  ...
  export class StaffService {
    ...
    private nameEntity: String = 'staff';
    ...
    getStaffsService(idSchool: number) {
    ...
    insertStaffService(dni: string, name: string, surname: string, idSchool: number){      
    ...
    updateStaffService(id: number, dni: string, name: string, surname: string, idSchool: number) {
